...
int castle_versions_init(void)
{
    ...
    BUG_ON(castle_btree_type_get(VLBA_TREE_TYPE)->max_entries(HDD_RO_TREE_LEAF_NODE_SIZE) < CASTLE_VERSIONS_MAX ||
           castle_btree_type_get(SLIM_TREE_TYPE)->max_entries(HDD_RO_TREE_LEAF_NODE_SIZE) < CASTLE_VERSIONS_MAX);
    ret = -ENOMEM;
